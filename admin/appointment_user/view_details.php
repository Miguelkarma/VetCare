    ...
    <div class="card card-outline card-dark rounded-0">
        ...
        <div class="card-body">
            <div class="container-fluid">
                                    ...
                                    <fieldset>
                                        ...
                                        <table class="table table-stripped table-bordered" data-placeholder='true' id="">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="border-info">
                                                    <th class="py-1 px-2 text-light" style="background-color:#b5651d">Contact Number</th>
                ...
                <?php endif; ?>
                        <a class="btn btn-sm btn-primary btn-flat" href="javascript:void(0)" id="update_status"><i class="fa fa-edit"></i>Edit Details</a>
