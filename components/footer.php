<link rel="stylesheet"  href="../ovas/components/css/footer.css">
<style>
 .all-footer{
  margin-top:5em;
 }
...
<footer class="pt-5">
    <div class="container d-row">
        ...
        <div class="row align-items-center">
            ...
            <!-- Social Media Icons -->
            <div class="col-lg-9 col-md-6 col-lg-7 d-lg-flex justify-content-end  fb-icon">
              
            
            <a href="https://www.facebook.com/" class="icon facebook" title="Facebook" target="_blank>">
