      ...
      <div class="container ">
          <div class="row  justify-content-center text-center  align-items-center ">
              ...
              <div class="col-12 col-md-12 col-xxl-6 px-0 ">
                  <div class="mb-4">
                      <a href="#">
                          <img src="<?php echo validate_image($_settings->info('logo')) ?>" alt="" class="mb-4 logo-inverse "  style="width: 100px; height: 100px; mix-blend-mode: multiply;">
                      </a>
                    <p class="lead">
   Veterinary care for your beloved pets. 
    We're here every weekend from <strong>7AM to 9PM</strong> to ensure your furry friends get the attention they deserve.
</p>
                  </div>
